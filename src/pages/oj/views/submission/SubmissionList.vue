    ...
    <div class="flex-container">
        <div id="main">
            <Panel shadow>
                ...
                <span>{{status}}
                  <Icon type="arrow-down-b"></Icon>
                                ...
                                <Dropdown-menu slot="list">
                                    ...
                                    <Dropdown-item v-for="status in Object.keys(JUDGE_STATUS)" :key="status"
                                                   :name="status">
                ...
                <Table stripe :disabled-hover="true" :columns="columns" :data="submissions"
                       :loading="loadingTable"></Table>
                <Pagination :total="total" :page-size="limit" @on-change="changeRoute"
